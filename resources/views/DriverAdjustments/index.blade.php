...
@section('content')
    ...
    <div class="modal fade" id="adjustmentPhotoModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="adjustmentPhotoModalTitle">Просмотр фото</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Закрыть"><span>&times;</span></button>
                </div>
                <div class="modal-body text-center adjustment-photo-modal__body">
                    <img id="adjustmentPhotoModalImage" class="img-fluid adjustment-photo-modal__image" src="" alt="">
                </div>
            </div>
        </div>
    </div>
